...
class Image_moo
{
    ...
    private $_accept_transparency = FALSE;
	...
	//----------------------------------------------------------------------------------------------------------
	{
		...
		try
		{
			...
			{
				case "image/gif"  :
					$this->_accept_transparency = TRUE;
	...
	private function _add_transparency()
	{
		if($this->_accept_transparency = TRUE)
		{
			imagesavealpha($this->temp_image, true);
			imagealphablending($this->temp_image, false);
			$transparent = imagecolorallocatealpha($this->temp_image, 0, 0, 0, 127);
			imagefill($this->temp_image, 0, 0, $transparent);
		}
	}
