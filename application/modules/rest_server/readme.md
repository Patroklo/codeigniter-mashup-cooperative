...
Cosas especiales de esta versión:

	Se puede llamar internamente así: $this->load->api('cy_comments/Comments/message_list', $params, 'html'(u otro tipo));


	Internamente convertirá $params en el formato necesario para que el método lo reciba (post, get, etc...).
	
	Retorna un texto, no lo muestra diréctamente por pantalla.
